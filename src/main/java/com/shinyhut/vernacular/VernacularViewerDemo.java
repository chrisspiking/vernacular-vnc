...
public class VernacularViewerDemo extends JFrame
{
    ...
    private VernacularViewerDemo(String initialURL)
    {
        this.initialURL = initialURL;
        this.initialPort = 5901;
        this.initialPassword = null;
        initUI();
    }
    
    private VernacularViewerDemo(String initialURL, int initialPort)
    {
        this.initialURL = initialURL;
    ...
    private VernacularViewerDemo(String initialURL, int initialPort, String initialPassword)
    {
        this.initialURL = initialURL;
        this.initialPort = initialPort;
    ...
    private void initialiseVernacularClient()
    {
        ...
        config.setUseLocalMousePointer(() -> localCursorMenuItem != null && localCursorMenuItem.isSelected());
    ...
    public static void main(String[] args)
    {
        invokeLater(() ->
                    {
                        VernacularViewerDemo viewer = null;
                        if (args.length == 2)
                        {
                            viewer = new VernacularViewerDemo(args[0], Integer.parseInt(args[1]));
                        }
                        else if (args.length == 3)
                        {
                            viewer = new VernacularViewerDemo(args[0], Integer.parseInt(args[1]), args[2]);
                        }
                        else
                        {
                            viewer = new VernacularViewerDemo();
                        }
